                        ...
                        <div className='row' >
                            <div className="col-md-6">
                                ...
                                <ul className="nav flex-column ">
                                    <li className="nav-item "><a href="#" className="nav-link p-4 text-white">Home</a></li>
                                    <li className="nav-item "><a href="#" className="nav-link p-4 text-white">Blog</a></li>
                                    <li className="nav-item "><a href="#" className="nav-link p-4 text-white">Login</a></li>
                                    <li className="nav-item "><a href="#" className="nav-link p-4 text-white">Register</a></li>
